...
def main():
    encrypt_image("./images/loki.jpg", 123, 4574574)
    decrypt_image("./images/rsa_encrypt.png", 123, 4574574)

    pass


def encrypt_image(file_path, key1, key2, outpath="./images/rsa_encrypt.png"):
...
def decrypt_image(file_path, key1, key2, outpath="./images/rsa_decrypt.png"):
    im, im_arr = load_image(file_path)
    x_size, y_size = im.size
